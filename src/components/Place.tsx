...
export function Place({ place: place }: PlaceProps) {
  ...
  return (
    <div className="border-neutral-800 border-2 py-2 px-4 rounded bg-[#022919] flex flex-col items-center mb-2 text-white">
      ...
      { details && 
      <div>
        <p><span className='font-bold'>Адрес:</span> { place.address }</p>
